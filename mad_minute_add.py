"""Generate configurable worksheets with addition-only defaults."""
...
def main() -> None:
    """Parse CLI options and write a PDF, defaulting to addition with operands 1-9.
    ...
    """
    options = parse_options("mad_minute_add.pdf", 1, 9, default_operations=("+",))
